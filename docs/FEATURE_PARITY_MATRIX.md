...
| Project delete | Immediate, no confirmation, non-cascading despite log text | REVIEW | Write migration | Approved confirmation/cascade policy is implemented and audited accurately | Yes |
...
| RAID comments | Create/read; RaidComments sheet auto-created; no edit/delete | REVIEW | Comments migration | Approved comment lifecycle and author identity are preserved | Yes |
