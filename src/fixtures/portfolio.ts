  ...
  projects: [
    {
      ...
      department: 'Infra & Ops', projectType: 'Key Project', createdAt, updatedAt,
    },
    {
      ...
      department: 'Cyber Security', projectType: 'BAU Project', createdAt, updatedAt,
    },
    {
      ...
      projectType: 'Unassigned', createdAt, updatedAt,
    },
    {
      ...
      projectType: 'BAU Project', createdAt, updatedAt,
    },
  ],
  activities: [
    { id: '20000000-0000-4000-8000-000000000001', legacyId: 'a-example-001', projectId: '10000000-0000-4000-8000-000000000001', name: 'Design approved', startDate: '2025-12-15', endDate: '2026-01-09', status: 'Completed', isMilestone: true, category: 'Planning', level: 0, sortOrder: 0, createdAt, updatedAt },
    { id: '20000000-0000-4000-8000-000000000002', legacyId: 'a-example-002', projectId: '10000000-0000-4000-8000-000000000001', name: 'Deployment wave', startDate: '2026-01-10', endDate: '2026-03-20', status: 'On Track', isMilestone: false, category: 'Execution', level: 1, sortOrder: 1, createdAt, updatedAt },
    { id: '20000000-0000-4000-8000-000000000003', legacyId: null, projectId: '10000000-0000-4000-8000-000000000002', name: 'Evidence collection', startDate: '2026-02-01', endDate: '2026-02-28', status: 'At Risk', isMilestone: false, category: 'Monitoring/Testing', level: 2, sortOrder: 0, createdAt, updatedAt },
  ],
  tasks: [
